About ioos_qartod-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ioos_qartod-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5401&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ioos_qartod-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ioos_qartod` can be installed with `conda`:
...
```
mamba install ioos_qartod
```

It is possible to list all of the versions of `ioos_qartod` available on your platform with `conda`:
...
```
mamba search ioos_qartod --channel conda-forge
```
...
mamba repoquery search ioos_qartod --channel conda-forge

# List packages depending on `ioos_qartod`:
mamba repoquery whoneeds ioos_qartod --channel conda-forge

# List dependencies of `ioos_qartod`:
mamba repoquery depends ioos_qartod --channel conda-forge
```
